...
function ContractInterface() {
    ...
    this.contract = (method, args) => {
        return new Promise(async (resolve, reject) => {
            ...
            if (web3.isConnected()) {
                ...
                let web3 = new Web3(new Web3.providers.HttpProvider('https://nn54wgx9u0.execute-api.us-east-1.amazonaws.com/prod/mainnet'));
                if (web3.isConnected()) {
    ...
    // This is used for only web3 call functions, not for transfer.
